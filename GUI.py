...
def Interpolator(img_path, mask_path, random_ratio, flag):
...
if __name__ == '__main__':
    ...
    tk.Button(root, text="Interpolator", command=lambda: Interpolator(img_path.get(), mask_path.get(), random_remove.get(), var.get())).pack()
